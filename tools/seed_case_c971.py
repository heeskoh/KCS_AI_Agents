...
기존 6종 지표 스키마에 맞춘 매핑:
  hs_classification  = 품명 위장 신고(핵심)  offshore_fund = 차명 경유 해외송금
  related_party      = 차명·공범 구조        undervaluation = 소액 분할신고
...
def main():
    ...
    insert_dicts(con, "import_risk_scores", [{
        ...
        # ── 심사 세트(참고) ──
        "undervaluation_suspicion_rate": 35.0,
        "related_party_anomaly_rate": 52.0,
        "fta_origin_misuse_suspicion_rate": 0.0,
        "customs_refund_anomaly_rate": 0.0,
        "hs_classification_error_rate": 88.0,
        "offshore_fund_concealment_suspicion_rate": 61.0,
