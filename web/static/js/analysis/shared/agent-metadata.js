...
export const AI_SERVICE_CATALOG = {
  db_cdw: cfg("CDW 조회", "db", DB_SEARCH_GROUP,
  ...
  cdw: { label:"CDW 조회", agentId:"db", category:DB_SEARCH_GROUP, adminVisible:false },
  db: { label:"CDW 조회", agentId:"db", category:DB_SEARCH_GROUP, adminVisible:false },
