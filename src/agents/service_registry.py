...
AI_SERVICE_TARGET_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "clearance_report": _cfg("신고번호와 현장 사진으로 통관보고서 작성", "신고번호와 현장 사진으로 통관보고서 작성"),
    ...
    "rag_item": _cfg("HSK 품목별 신고 가이드에서 해당 물품의 품명·규격·성분·수입요건·유의사항을 확인", "개인 반입 물품의 HSK 품목별 신고 가이드(품명·규격·수입요건)를 확인"),
    ...
    "web": _cfg("참고 URL을 등록하고 업체, 공급망, 가격 변동 관련 외부정보 수집을 요청", "참고 URL을 등록하고 인물, 조직, 사건, 여행 경로 관련 외부정보 수집을 요청"),
    "web_search": _cfg("참고 URL을 등록하고 업체, 공급망, 가격 변동 관련 외부정보 수집을 요청", "참고 URL을 등록하고 인물, 조직, 사건, 여행 경로 관련 외부정보 수집을 요청"),
    ...
    "address_check": _cfg("카카오지도(로컬) API로 주소를 확인해 개인주소(주거용)인지 사업장(상업용)인지 판별", "대상자 주소지를 카카오지도 API로 확인해 주거지 실재·사업장 여부를 판별"),
    ...
    "summary": _cfg("요약 대상을 조사관용 핵심 요약으로 정리", "요약 대상을 개인 수사 담당자용 핵심 요약으로 정리"),
    "report": _cfg("보고서 대상 자료를 공식 조사보고서 초안으로 통합", "보고서 대상 자료를 개인 수사보고서 초안으로 통합"),
    "report_generate": _cfg("보고서 대상 자료를 공식 조사보고서 초안으로 통합", "보고서 대상 자료를 개인 수사보고서 초안으로 통합"),
