...
AI_SERVICE_TARGET_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "rag_customs": _cfg("과세가격, 원산지, 품목분류 관련 규정 근거 확인", "휴대품, 여행자 통관, 조사 절차 관련 규정 근거 확인"),
    "rag_trade": _cfg("통관/무역 정보에서 이상 징후와 참고 근거 확인", "개인 반입·운송·거래 정보에서 이상 징후와 참고 근거 확인"),
    "rag_audit": _cfg("감사 정보와 추징 가능성 관점의 조사 포인트 정리", "개인 사건 검토 이력과 추징 가능성 관점의 조사 포인트 정리"),
    "rag_investigation": _cfg("조사 정보 기반으로 조사 순서와 확인 자료 정리", "개인 수사 정보 기반으로 수사 순서와 확인 자료 정리"),
    "rag_global": _cfg("국제 정보 기반으로 해외 거래구조와 위험 신호 확인", "국제 여행·체류·공조 정보 기반으로 개인 위험 신호 확인"),
    ...
    "web": _cfg("업체, 공급망, 가격 변동 관련 기사 확인", "인물, 조직, 사건, 여행 경로 관련 공개 정보를 확인"),
    "web_search": _cfg("업체, 공급망, 가격 변동 관련 기사 확인", "인물, 조직, 사건, 여행 경로 관련 공개 정보를 확인"),
    ...
    "mail_share": _cfg("분석 결과보고서를 내부메일 본문과 첨부 요약으로 구성하여 관련 부서에 공유", "개인 수사 결과보고서를 내부메일 본문과 첨부 요약으로 구성하여 관련 부서에 공유"),
}
