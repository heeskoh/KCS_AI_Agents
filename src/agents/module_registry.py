...
AGENT_MODULES: tuple[AgentModule, ...] = (
    AgentModule("company", "기업 프로파일 조회", agent_company, "company_result", "company_agent", ("company_lookup",)),
    AgentModule("db", "CDW 조회", agent_db, "db_result", "db_agent", ("db_cdw", "cdw")),
    AgentModule("rag_customs", "관세e음 RAG", result_key="rag_result", node_prefix="rag_customs_agent", runner_factory=_rag_runner),
    AgentModule("rag_trade", "통관정보 RAG", result_key="rag_result", node_prefix="rag_trade_agent", runner_factory=_rag_runner),
    ...
    AgentModule("rag_global", "국제정보 RAG", result_key="rag_result", node_prefix="rag_global_agent", runner_factory=_rag_runner),
    ...
    AgentModule("origin_analysis", "원산지 분석", agent_origin_analysis, "origin_analysis_result", "origin_analysis_agent"),
